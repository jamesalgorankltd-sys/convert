...
async function resolve(input) {
  ...
  // For normal URLs, nested direct images are useful.
  // For Magnific pages, do NOT use hash/query first because that value can belong to
  // the previous search/reference image and can return a different picture.
  if (!isMagnificPage) {
